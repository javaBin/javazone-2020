...
export function CoronaPage() {
    return (
        <>
            ...
            <Section color="pink" header={<h1>I already have a ticket, but I cannot attend in January, can I get a refund?</h1>}>
                <p>
            ...
            <Section color="pink" header={<h1>What will the format of the conference in January be?</h1>}>
                <p>
