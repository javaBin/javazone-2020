    ...
    return (
        <>
            ...
            <Section color="pink" header={<h1>Information</h1>}>
                <p>
                    Due to the COVID-19 outbreak we have decided to postpone JavaZone 2020. We will try a new concept: JavaZone VR. This will be an online conference held on September 9th.
                </p>
            </Section>
            ...
            <Section color="pink" header={<h1>So I have already bought a ticket, is it still valid?</h1>}>
                <p>
                    Yes, of course. Your ticket is valid for the next physical conference. Participation in the JavaZone VR conference in September is also included.
                </p>
            </Section>
            ...
            <Section color="pink" header={<h1>What will the format of the next physical conference be?</h1>}>
                <p>
            ...
            <Section color="pink" header={<h1>So what is this JavaZone VR conference?</h1>}>
                <p>
            ...
            <Section color="pink" header={<h1>What about JavaZone 2021, will that be happening in September 2021?</h1>}>
                <p>
